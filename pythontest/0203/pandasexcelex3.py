...
@author: GDJ_19
Purchase Date 컬럼 중 값이 '01/24/2013' 와 '01/31/2013' 인 
...
# data_frame : sales_2013.xlsx 파일의 january_2014 sheet 모든 내용
data_frame = pd.read_excel\
                  (input_file, "january_2013", index_col=None)
select_data = ['01/24/2013', '01/31/2013']
# isin : 속한 값인 경우만 선택
# data_frame_value : '01/24/2013', '01/31/2013'날짜에 해당하는 모든 데이터
data_frame_value = \
    data_frame[data_frame['Purchase Date'].isin(select_data)]
